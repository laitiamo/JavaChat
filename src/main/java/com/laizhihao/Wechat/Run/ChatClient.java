...
public class ChatClient extends JFrame implements ActionListener {
    ...
    public ChatClient() {
        ...
        txtscrollpane = new JScrollPane(txtViewTalk);
        listOnline = new JComboBox();
        txtViewTalk.setForeground(Color.BLACK);
        ...
        pnlTalk.add(btnTalk);
        pnlBack.add("Center", txtscrollpane);
        pnlBack.add("South", pnlTalk);
        pnlTalk.setBackground(new Color(52, 130, 203));
        btnTalk.setEnabled(true);

        clientFrame.getContentPane().add(pnlBack);
        clientFrame.setSize(600, 450);
        clientFrame.setLocation((screen.width) / 2, (screen.height) / 2);
        ...
        dialogLogin.getContentPane().setBackground(Color.white);
        dialogLogin.setLocation((screen.width) / 2, (screen.height / 2));
